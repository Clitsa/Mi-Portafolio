...
A) Situación:
  Una empresa de bebidas requería reportes de gestión de gastos completos y precisos desde enero de 2021 hasta la fecha actual. Estos informes eran esenciales para analizar patrones de gasto, identificar áreas de ahorro potencial y tomar decisiones informadas sobre la asignación de recursos.
...
B) Solución:
 ...
 1. Preparación de datos en Excel:
  ...
  - Limpieza y organización de datos: Una vez recopilados, limpié y organicé los datos para garantizar su precisión y consistencia. Elimine filas duplicadas, corrija errores de formato y aseguré que todos los campos tuvieran nombres y formatos uniformes.
  - Consolidación de datos: Los consolidados en un único archivo de Excel para facilitar el análisis posterior.
  - Diseñé un tablero en Excel como esquema previo a la elaboración de los informes en Power BI. Esto me permitió definir los indicadores con claridad y consistencia, y comenzar a ajustar las visualizaciones a las necesidades de los usuarios de los informes.
...
3. Gestión de los informes en Power BI:
  - Obtener Licencias Pro de Power BI: Gestioné la obtención de las licencias para los usuarios de los informes con compras y resolví junto con TI las incidencias que surgieron para su ejecución.
...
C) Beneficios:
  ...
  - Mayor visibilidad de patrones de gasto: Las visualizaciones de Power BI me facilitan la identificación de tendencias y anomalías en los patrones de gasto de la empresa.
